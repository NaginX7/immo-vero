...
/**
 * Logo de la marque (maison + cœur).
 *
 * SVG inline plutôt que <Image> : le tracé utilise `currentColor`, la couleur
 * suit donc la classe de texte appliquée (ex. `text-white`). Une balise <img>
 * ne permettrait pas de le recolorer.
 */
